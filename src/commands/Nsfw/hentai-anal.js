...
module.exports = class Hanal extends Command {
  constructor (client) {
    super(client, {
      name: 'hentai-anal',
      cooldown: 10,
      ...
      usage: (language, prefix) => language.get('NSFW_USAGE', prefix, 'hentai-anal'),
      category: (language) => language.get('UTILS').NSFW_CATEGORY,
      examples: (language, prefix) => language.get('NSFW_EXEMPLE', prefix, 'hentai-anal')
    })
  }
