  ...
  async run (message, args) {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
        ...
        .attachFiles(['images/icons/npm.png'])
        .setAuthor('NPM', 'attachment://npm.png', 'https://www.npmjs.com/')
        ...
        .addField(message.language.get('NPM')[4], this.client.functions.timestampToDate(Date.parse(body.objects[0].package.date), message))
